# Generated by Django 2.1 on 2018-08-31 06:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passwd', models.CharField(blank=True, max_length=256, verbose_name='密码')),
                ('session', models.CharField(blank=True, max_length=16, verbose_name='Cookice_session')),
                ('expsession', models.TimeField(blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='pureftp',
